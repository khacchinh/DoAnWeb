					...
					<div class="col-md-12 col-sm-12 col-xs-12">
		                <div class="x_panel">
		                  <div class="x_title">
		                    ...
		                    <a class="btn btn-default" type="button" style="float: right;" href="<?php echo admin_url('catalog/add'); ?>">Thêm mới</a>
		                      ...
		                      <table class="table table-striped jambo_table bulk_action">
		                        <thead>
		                          <tr class="headings">
		                            ...
		                            <th class="column-title">Ưa tiên hiển thị </th>
		                        ...
		                        <tbody>
		                        	<?php foreach ($list as $row):?>
			                          <tr class="even pointer">
			                            ...
			                            <td class=" last">
			                            	<a class="btn btn-info btn-xs" href="<?php echo admin_url('catalog/edit/'.$row->id); ?>"><i class="fa fa-pencil"></i>Sửa</a> 
			                            	<a class="btn btn-danger btn-xs" href="<?php echo admin_url('catalog/delete/'.$row->id); ?>"><i class="fa fa-trash-o"></i>Xóa</a>
			                            </td>
			                          </tr>
			                        <?php endforeach; ?>
		                        </tbody>
