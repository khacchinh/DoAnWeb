		                  	...
		                  	<form class="form-horizontal form-label-left" novalidate="" method="post">
		                        ...
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tên danh mục <span class="required">*</span>
			                        ...
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Tên danh mục" required="required" type="text" value="<?php echo $info->name ?>">
			                        </div>
		                        ...
		                        <label class="control-label col-md-3" for="sort_order">Thứ tự hiển thị<span class="required">*</span></label>
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                          <input type="text" class="form-control col-md-7 col-xs-12" data-validate-length="6,8" name="sort_order" placeholder="Thứ tự hiển thị" value="<?php echo $info->sort_order; ?>" >
			                        </div>
